...
export const CompanyProvider = ({ children }) => {
    ...
    // Get company ID from localStorage or other source (you can modify this)
    const getCompanyId = () => {
        // You can get this from localStorage, URL, or authentication context
        ...
        return {
            company: {
                ...
                settings: {
                    ...
                    navigation: defaultNavigation.filter(item => item.id !== 'export'),
