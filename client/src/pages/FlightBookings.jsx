...
const FlightBookings = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('flight')} - SaaS Management System</title>
      </Helmet>
      <div className="space-y-6">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>Flight Bookings Overview</CardTitle>
              <CardDescription>
                This section will contain flight booking details and management tools.
              </CardDescription>
            </CardHeader>
            <CardContent>
