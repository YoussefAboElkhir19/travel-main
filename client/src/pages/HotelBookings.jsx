...
const HotelBookings = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('hotels')} - SaaS Management System</title>
      </Helmet>
      <div className="space-y-6">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>Hotel Bookings Overview</CardTitle>
              <CardDescription>
                This section will contain hotel booking details and management tools.
              </CardDescription>
            </CardHeader>
            <CardContent>
