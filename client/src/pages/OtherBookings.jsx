...
const OtherBookings = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('other')} - SaaS Management System</title>
      </Helmet>
      <div className="space-y-6">
        ...
        >
          <div>
            <h1 className="text-3xl font-bold text-gradient flex items-center space-x-3">
              ...
              <span>{t('other')} {t('bookings')}</span>
            </h1>
            <p className="text-muted-foreground mt-2">
              Manage all other types of reservations.
            </p>
          </div>
        </motion.div>
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>Other Bookings Overview</CardTitle>
              <CardDescription>
                This section will contain other booking details and management tools.
              </CardDescription>
            </CardHeader>
            <CardContent>
