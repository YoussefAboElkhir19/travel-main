...
const VisaPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Visa Applications - SaaS Management System</title>
      </Helmet>
      <div className="space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Manage visa application processes.
            </p>
          </div>
        </motion.div>
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>Visa Applications Overview</CardTitle>
              <CardDescription>
                This section will contain visa application details and management tools.
              </CardDescription>
            </CardHeader>
            <CardContent>
