...
const MailsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('mails')} - SaaS Management System</title>
      </Helmet>
      <div className="space-y-6">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>Mails Overview</CardTitle>
              <CardDescription>
                This section will contain mail integration details and management tools.
              </CardDescription>
            </CardHeader>
            <CardContent>
